...
--               decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ LED_Demo_0_sim_netlist.vhdl
-- Design      : LED_Demo_0
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_LED_Task is
  port (
    LED_tri_o : out STD_LOGIC_VECTOR ( 0 to 0 );
    clk_100MHz : in STD_LOGIC
  );
end decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_LED_Task;

architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_LED_Task is
  signal Clk : STD_LOGIC;
  signal \^led_tri_o\ : STD_LOGIC_VECTOR ( 0 to 0 );
  signal p_0_in : STD_LOGIC;
begin
  LED_tri_o(0) <= \^led_tri_o\(0);
Clk_Division1: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_Clk_Division
     port map (
      Clk => Clk,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_LED_Demo is
  port (
...
end decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_LED_Demo;

architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_LED_Demo is
  signal \^led_tri_o\ : STD_LOGIC_VECTOR ( 1 to 1 );
  signal clk_10MHz : STD_LOGIC;
begin
  LED_tri_o(1) <= \^led_tri_o\(1);
  LED_tri_o(0) <= \^led_tri_o\(1);
LED_Task0: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_LED_Task
     port map (
      LED_tri_o(0) => \^led_tri_o\(1),
      clk_100MHz => clk_100MHz
    );
RGB_LED_Task0: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_RGB_LED_Task
     port map (
      B_In1(7 downto 0) => B_In1(7 downto 0),
      B_In2(7 downto 0) => B_In2(7 downto 0),
      G_In1(7 downto 0) => G_In1(7 downto 0),
...
clk_10: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_clk_wiz_0
     port map (
      clk_100MHz => clk_100MHz,
      clk_10MHz => clk_10MHz
    );
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  attribute CHECK_LICENSE_TYPE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix : entity is "LED_Demo_0,LED_Demo,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix : entity is "package_project";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix : entity is "LED_Demo,Vivado 2018.3";
end decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix;

architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
begin
inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_LED_Demo
     port map (
      B_In1(7 downto 0) => B_In1(7 downto 0),
      B_In2(7 downto 0) => B_In2(7 downto 0),
      G_In1(7 downto 0) => G_In1(7 downto 0),
