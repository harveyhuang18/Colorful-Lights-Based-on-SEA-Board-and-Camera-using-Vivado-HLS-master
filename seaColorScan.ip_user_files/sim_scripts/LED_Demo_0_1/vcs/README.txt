...
'-reset_run' switch to the './LED_Demo_0.sh' script.

./LED_Demo_0.sh -reset_run
...
./LED_Demo_0.sh -noclean_files

For more information on the script, please type './LED_Demo_0.sh -help'.
